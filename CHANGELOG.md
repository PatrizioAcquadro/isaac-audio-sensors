...
- Preserved the six fixed-shape Isaac Lab tensors and CUDA-native lifecycle while removing source-conditioned tensor assembly. Entity and reference bindings intentionally expose zero observations until Plan 03.3 integrates observed activity.
