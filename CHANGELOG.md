...
- Integrated `analytic_acoustics` occlusion with Isaac lifecycle raycasts and retained direct-only behavior in the four legacy backends. `surface_set`, entity-batched Lab execution, and removal of legacy backend identifiers remain deferred until their owning phases and consumer migrations.
