...
RMS instruments consume the observed microphone mixture. Nullable frame-v4 confidence displays `N/A` when unavailable. A separate simulation-geometry label reports blocked/total direct paths without attributing occlusion to any perceived event or coloring a direction by simulation truth. The compass still hides multiple-event bearings and ambiguity candidates without a primary bearing; their full presentation belongs to [[implementation_phases/07-isaac-lab-observation-integration|07.3]]. Frame-age warnings remain. Provider diagnostics are extended in [[implementation_phases/r10-geometry-acoustics-integration|08.3/R10.3]], and useful effect controls follow [[implementation_phases/09-practical-realism-and-randomization|Phase 09]].
