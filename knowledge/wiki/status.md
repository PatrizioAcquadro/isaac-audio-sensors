...
The R8.4 closure gate passes 460 host tests, 200 integration tests, 57 release tests, 100 tests through the supported Isaac runtime, configuration and fixture validation, optional audio, Ruff, version synchronization, and whitespace. RTX 4090 live Isaac Sim records blocked factor `1.0` changing to clear factor `0.0`, serializable transient occlusion rays/hits, and geometry-free detection diagnostics. Live Isaac Lab preserves parity and partial reset over 50 steps and 4096 environments at 2.241 ms/step mean against the 20 ms budget; Kit passes all 38 workflow steps with four-channel waveform output and a readable non-silent device mix. The unchanged SquadBot checkout passes 373 tests with 10 expected skips. A temporary clean clone of implementation commit `33812b6` passes release preflight and the complete `3.0.0` sdist, universal-wheel, and Kit-ZIP audit. Regenerated frame, manifest, and calibration schemas are byte-identical with SHA-256 `58e99421940644b49d627f7404326423028a5b5f4a307890e3ca360d23479b73`, `012bf6a51d3d9f5c79b6a973d9124bb5fdbf21cfd1fb4739ead0609b82f55525`, and `fb56c9024bfa16ce25a999ed8e2552ab19189459f44801f33edd9f0d75d1ff46`, respectively. No artifact was pushed, tagged, or published.
