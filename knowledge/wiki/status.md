...
Subphases 04.1–04.3 of [[implementation_phases/04-observed-direction-estimation|Plan 04]] and 05.1–05.3 of [[implementation_phases/05-ground-truth-and-learning-datasets|Plan 05]] are complete. Subphases 06.1 and 06.2 are complete: common signal semantics, downstream native/SSH acquisition, shared perception, recording/replay, and explicit fault handling pass. The 17-take physical campaign and recovered 102-WAV historical audit pass their checks. Current ch1/ch2 gains are rejected; ch3 is inconclusive, so live corrections remain disabled. Functional mapping orientation and unchanged +1 polarities are supported within the declared bench scope. See Plan 06 for metrics and limits. Next are 06.3 comparison, Lab tensor projection, and the selected Geometry Acoustics provider.
