...
On 2026-09-09 the user reopened reliable joint event count and direction over time and requested the following work **before 07.2**. This supersedes the earlier decision to pause motion-perception research and proceed with the bounded reference. These are requested outcomes, not completed implementations:
...
- [[implementation_phases/02-signal-and-perception-architecture|Confidence availability]]: distinguish an unavailable confidence from measured zero through observations, replay, GUI and Lab.
