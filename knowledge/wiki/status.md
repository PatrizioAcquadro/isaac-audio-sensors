...
- [[implementation_phases/r8-analytic-acoustics-backend#Pre-07.2 Follow-up — Live Occlusion Correctness|Live occlusion correctness]]: complete-segment PhysX queries support validated solid primitives/meshes; unavailable requested occlusion stops capture and clears current GUI output. Geometric path diagnostics remain separate from observed reliability.
