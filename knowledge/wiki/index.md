...
- [[implementation_phases/06-simulated-and-real-signal-parity|06 Simulated and Real Signal Parity]] — define general signal semantics, integrate ReSpeaker as the first physical reference, and compare sim–real behavior without device-specific perception.
