...
def test_base_import_then_activation_keeps_numpy_host_owned(tmp_path):
    ...
    assert payload["l2"] == "pack:acoustics-l2l3@2.0.0"
    assert payload["room"] == "pack:acoustics-l2l3@2.0.0"
    assert payload["wav"] == "pack:acoustics-l2l3@2.0.0"
    assert payload["active_pack"] == "acoustics-l2l3@2.0.0"
