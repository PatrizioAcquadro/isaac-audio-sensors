"""Frozen S3.4 seeded-noise verification protocol."""
...
from test_waveform_export import _CaptureSink, _quad_array
...
def test_backend_off_state_golden_and_enabled_registry_style_determinism(monkeypatch):
    ...
    ).hexdigest() == PREEDIT_WAVEFORM_SHA256
