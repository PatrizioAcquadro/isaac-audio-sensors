...
EXPECTED_PACKAGE_FILES = {
    ...
    f"{SCHEMA_ROOT}/audio_dataset_manifest.v4.schema.json",
    f"{SCHEMA_ROOT}/audio_sensor_frame.v4.schema.json",
}
...
Provides-Extra: room
Requires-Dist: nara-wpe==0.0.11; extra == "room"
...
def _write_sdist(
    ...
    *,
    ...
    package_files = {
        ...
        "schemas/audio_dataset_manifest.v4.schema.json": b"{}\n",
        "schemas/audio_sensor_frame.v4.schema.json": b"{}\n",
    }
