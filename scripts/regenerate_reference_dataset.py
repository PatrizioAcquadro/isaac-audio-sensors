"""Regenerate the deterministic S2.1 reference dataset fixture."""
...
REFERENCE_DIR = REPO_ROOT / "examples" / "datasets" / "reference_session_v1"
...
WRITER_TOOL_VERSION = "ias_fixture_generator/1.8.0"
...
def regenerate_reference_dataset(output_dir: str | Path = REFERENCE_DIR) -> Path:
    ...
    if actual_plan != expected_plan:
        raise AssertionError(f"Unexpected frozen fixture shard plan: {actual_plan!r}")
    ...
    manifest = AudioDatasetManifest(
        ...
        license="CC0-1.0",
        source="Deterministic synthetic S2.1 reference fixture",
        runtime_profile="waveform_fidelity",
