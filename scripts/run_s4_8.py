#!/usr/bin/env python3
"""Prevalidate or explicitly execute the one-shot S4.8 evaluation."""
...
def main() -> int:
    ...
    try:
        if args.preopen:
            ...
            if args.source_commit is None or args.event_time_utc is None:
                parser.error(
                    "--execute requires --source-commit and --event-time-utc"
                )
            result = run_authorized_evaluation_once(
                args.repo_root,
                source_commit=args.source_commit,
