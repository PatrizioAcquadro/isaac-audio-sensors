...
REQUIRED_SDIST_ENTRIES = (
    ...
    "packs/acoustics/requirements.lock",
    ...
    "examples/manifests/invalid/invalid_frame_range_nonmonotonic.json",
    "examples/manifests/invalid/invalid_timestamps_nonmonotonic.json",
    "examples/manifests/invalid/invalid_channel_order_duplicate.json",
    "examples/manifests/invalid/invalid_asset_checksum_format.json",
    "examples/manifests/invalid/invalid_checksum_format.json",
    "examples/manifests/invalid/invalid_complete_manifest_incomplete_shard.json",
    "examples/manifests/invalid/invalid_completion_state_unknown.json",
    "examples/manifests/invalid/invalid_coordinate_frame.json",
    "examples/manifests/invalid/invalid_split_unknown_group.json",
    "examples/manifests/invalid/invalid_runtime_profile_unknown.json",
    ...
    "examples/calibration/invalid/invalid_channel_order_duplicate.json",
    "examples/calibration/invalid/invalid_checksum_format.json",
    "examples/calibration/invalid/invalid_schema_version.json",
    "examples/calibration/invalid/invalid_unmeasured_has_value.json",
    ...
    "scripts/audit_acoustic_pack.py",
    "scripts/audit_distribution.py",
    "scripts/build_acoustic_pack.py",
