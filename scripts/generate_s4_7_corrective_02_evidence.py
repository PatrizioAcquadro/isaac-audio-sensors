#!/usr/bin/env python3
"""Generate the deterministic S4.7 corrective_02 evidence package."""
...
from isaac_audio_sensors.acquisition.s4_7_corrective_02 import (  # noqa: E402
    OUTPUT_PATH,
...
def main() -> int:
    ...
    try:
        ...
        print(f"S4.7 corrective_02 evidence: failed: {exc}", file=sys.stderr)
        return 1
